...
# I got the best result for K = 1 because the accuracy is 100%, and I got the same result for K = 3 and 5.
# My model's accuracy increased after I removed the "Age" feature, indicating that we cannot predict gender effectively using the age feature. Furthermore, the height and weight features are independent of the age feature.
# 
